...
namespace MyAPI.EShopApp.Data.Migrations
{
    ...
    [Migration("20240531194733_fixed models and dtos, added more dtos")]
    partial class fixedmodelsanddtosaddedmoredtos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyAPI.EShopApp.Data.Models.PurchaseLogProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MyAPI.EShopApp.Data.Models.PurchaseLogProduct", b =>
                {
                    ...
                    b.HasOne("MyAPI.EShopApp.Data.Models.PurchaseLog", "PurchaseLog")
                        .WithMany("PurchaseLogProducts")
            ...
            modelBuilder.Entity("MyAPI.EShopApp.Data.Models.PurchaseLog", b =>
                {
                    b.Navigation("PurchaseLogProducts");
                });
