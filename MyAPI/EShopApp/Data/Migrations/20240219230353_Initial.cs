        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseLogId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "AddedOn", "Barcode", "Description", "Images", "Name", "Price", "PurchaseLogId", "Quantity", "Sells", "SubCategoryId" },
                values: new object[,]
                {
                    { new Guid("45ee830f-a1f3-44ad-8112-982ef324dab4"), new DateOnly(1, 1, 1), null, "Description Test", "[\"1.jpg\",\"2.jpg\"]", "Hair Care Kit", 200, null, 0, 0, new Guid("3e80f63e-6866-4a58-a7e7-8151b8c7c199") },
                    { new Guid("4679e631-8273-49cd-91a6-fae714ea9d73"), new DateOnly(1, 1, 1), null, "Description Test", "[\"1.jpg\",\"2.jpg\"]", "Videogame", 500, null, 0, 0, new Guid("f1c3a402-5e08-4e13-a08f-4d9ab5062a9e") },
                    { new Guid("4eaf8297-449c-4aea-a656-a92b8730a201"), new DateOnly(1, 1, 1), null, "Description Test", "[\"1.jpg\",\"2.jpg\"]", "PC Build 2024", 500, null, 0, 0, new Guid("ec5e2a09-3785-4b4b-90e6-1353ddb5aee6") },
                    { new Guid("4fe905ac-63ae-4e9c-a10f-b6379b594c18"), new DateOnly(1, 1, 1), null, "Description Test", "[\"1.jpg\",\"2.jpg\"]", "Face Cosmetic Kit", 74, null, 0, 0, new Guid("3e80f63e-6866-4a58-a7e7-8151b8c7c199") },
                    { new Guid("710df7a2-9cf9-4b80-89d5-20be76a621af"), new DateOnly(1, 1, 1), null, "Description Test", "[\"1.jpg\",\"2.jpg\"]", "Body Care Kit", 1000, null, 0, 0, new Guid("3e80f63e-6866-4a58-a7e7-8151b8c7c199") },
                    { new Guid("b199f9b1-cf03-4990-876e-492df1cf69d1"), new DateOnly(1, 1, 1), null, "Description Test", "[\"1.jpg\",\"2.jpg\"]", "Playstation 5", 500, null, 0, 0, new Guid("f1c3a402-5e08-4e13-a08f-4d9ab5062a9e") },
                    { new Guid("f4411dd9-d96a-4104-9d33-30f7beb3ad05"), new DateOnly(1, 1, 1), null, "Description Test", "[\"1.jpg\",\"2.jpg\"]", "Air Fryer", 500, null, 0, 0, new Guid("3ac2239f-3d70-4da0-b81e-bda272847e7c") },
                    { new Guid("f741ceca-8eed-40a6-8706-3181886a2e23"), new DateOnly(1, 1, 1), null, "Description Test", "[\"1.jpg\",\"2.jpg\"]", "Android Tablet", 500, null, 0, 0, new Guid("92c17ce6-92b8-4515-9fc3-e38fcc51d83e") }
                });
